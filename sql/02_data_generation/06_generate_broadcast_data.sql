...
SELECT
    ...
    UNIFORM(1000000, 10000000, RANDOM()) AS total_viewership,
    UNIFORM(500000, 3000000, RANDOM()) AS avg_concurrent_viewers,
    UNIFORM(180, 300, RANDOM()) AS broadcast_duration_minutes,
    PARSE_JSON(
        CASE m.country
